import{r as P,j as e,M as A,B as g,bu as N,bv as p,ay as O,T as o,P as b,av as Q,ag as k,aA as K,G as q,t as $}from"./index-C0en13-S.js";import{C as ee,a as ae,b as ie}from"./ComponentSkeleton-BKj5Q7A5.js";import"./Skeleton-DRGJBKcs.js";function B({children:i,value:l,index:n,...c}){return e.jsx("div",{role:"tabpanel",hidden:l!==n,id:`simple-tabpanel-${n}`,"aria-labelledby":`simple-tab-${n}`,...c,children:l===n&&e.jsx(g,{sx:{pt:2},children:i})})}function E(i){return{id:`simple-tab-${i}`,"aria-controls":`simple-tabpanel-${i}`}}function te(){const[i,l]=P.useState(0),n=(v,u)=>{l(u)};return e.jsx(A,{codeString:`// BasicTabs.tsx
