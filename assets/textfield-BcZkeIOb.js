import{r as b,j as e,G as d,t as i,M as l,y as t,aT as r,aU as o,x as a,aE as g,bn as j,bG as w}from"./index-C0en13-S.js";import{C as f,a as y,b as I}from"./ComponentSkeleton-BKj5Q7A5.js";import{E as u}from"./EyeInvisibleOutlined-BDts_yaX.js";import{E as T}from"./EyeOutlined-HtCwYwcl.js";import"./Skeleton-DRGJBKcs.js";function z(){const[n,c]=b.useState({password:"",showPassword:!1}),p=s=>m=>{c({...n,[s]:m.target.value})},x=()=>{c({...n,showPassword:!n.showPassword})},h=s=>{s.preventDefault()};return e.jsxs(f,{children:[e.jsx(y,{title:"Text Field",caption:"Text fields let users enter and edit text.",directory:"src/pages/components-overview/textfield",link:"https://mui.com/material-ui/react-text-field/"}),e.jsx(I,{children:e.jsxs(d,{container:!0,spacing:3,children:[e.jsx(d,{item:!0,xs:12,lg:6,children:e.jsxs(i,{spacing:3,children:[e.jsx(l,{title:"Basic",codeHighlight:!0,codeString:`<TextField id="outlined-basic" label="Outlined" />
