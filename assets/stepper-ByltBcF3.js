import{c9 as W,ca as $,ba as L,ct as X,ah as y,r as x,cc as V,bC as I,a3 as Y,j as e,ce as F,cf as O,b0 as z,M as w,d5 as E,B as r,d,T as h,P as m,aX as J,G as T,t as A}from"./index-C0en13-S.js";import{C as K,a as Z,b as ee}from"./ComponentSkeleton-BKj5Q7A5.js";import{c as U,d as H,b as R,S as P,a as D}from"./Stepper-t63dG8Xd.js";import{S as te}from"./index-H6hefU-Z.js";import{L as ie}from"./LeftOutlined-DDO49HS3.js";import"./Skeleton-DRGJBKcs.js";function se(t){return $("MuiStepButton",t)}const ne=W("MuiStepButton",["root","horizontal","vertical","touchRipple"]),M=ne,ae=["children","className","icon","optional"],oe=t=>{const{classes:i,orientation:s}=t;return O({root:["root",s],touchRipple:["touchRipple"]},se,i)},re=L(X,{name:"MuiStepButton",slot:"Root",overridesResolver:(t,i)=>{const{ownerState:s}=t;return[{[`& .${M.touchRipple}`]:i.touchRipple},i.root,i[s.orientation]]}})(({ownerState:t})=>y({width:"100%",padding:"24px 16px",margin:"-24px -16px",boxSizing:"content-box"},t.orientation==="vertical"&&{justifyContent:"flex-start",padding:"8px",margin:"-8px"},{[`& .${M.touchRipple}`]:{color:"rgba(0, 0, 0, 0.3)"}})),le=x.forwardRef(function(i,s){const n=V({props:i,name:"MuiStepButton"}),{children:l,className:g,icon:u,optional:c}=n,v=I(n,ae),{disabled:b,active:C}=x.useContext(U),{orientation:a}=x.useContext(H),p=y({},n,{orientation:a}),S=oe(p),o={icon:u,optional:c},f=Y(l,["StepLabel"])?x.cloneElement(l,o):e.jsx(R,y({},o,{children:l}));return e.jsx(re,y({focusRipple:!0,disabled:b,TouchRippleProps:{className:S.touchRipple},className:F(S.root,g),ref:s,ownerState:p,"aria-current":C?"step":void 0},v,{children:f}))}),ue=le;function ce(t){return $("MuiStepContent",t)}W("MuiStepContent",["root","last","transition"]);const pe=["children","className","TransitionComponent","transitionDuration","TransitionProps"],de=t=>{const{classes:i,last:s}=t;return O({root:["root",s&&"last"],transition:["transition"]},ce,i)},me=L("div",{name:"MuiStepContent",slot:"Root",overridesResolver:(t,i)=>{const{ownerState:s}=t;return[i.root,s.last&&i.last]}})(({ownerState:t,theme:i})=>y({marginLeft:12,paddingLeft:20,paddingRight:8,borderLeft:i.vars?`1px solid ${i.vars.palette.StepContent.border}`:`1px solid ${i.palette.mode==="light"?i.palette.grey[400]:i.palette.grey[600]}`},t.last&&{borderLeft:"none"})),xe=L(z,{name:"MuiStepContent",slot:"Transition",overridesResolver:(t,i)=>i.transition})({}),he=x.forwardRef(function(i,s){const n=V({props:i,name:"MuiStepContent"}),{children:l,className:g,TransitionComponent:u=z,transitionDuration:c="auto",TransitionProps:v}=n,b=I(n,pe);x.useContext(H);const{active:C,last:a,expanded:p}=x.useContext(U),S=y({},n,{last:a}),o=de(S);let f=c;return c==="auto"&&!u.muiSupportAuto&&(f=void 0),e.jsx(me,y({className:F(o.root,g),ref:s,ownerState:S},b,{children:e.jsx(xe,y({as:u,in:C||p,className:o.transition,ownerState:S,timeout:f,unmountOnExit:!0},v,{children:l}))}))}),ge=he,B=["Select campaign settings","Create an ad group","Create an ad"];function k({children:t,value:i,index:s,...n}){return e.jsx("div",{role:"tabpanel",hidden:i!==s,id:`simple-tabpanel-${s}`,"aria-labelledby":`simple-tab-${s}`,...n,children:i===s&&e.jsx(r,{sx:{p:3},children:t})})}function Se(){const[t,i]=x.useState(0),[s,n]=x.useState(new Set),l=a=>a===1,g=a=>s.has(a),u=()=>{let a=s;g(t)&&(a=new Set(a.values()),a.delete(t)),i(p=>p+1),n(a)},c=()=>{i(a=>a-1)},v=()=>{if(!l(t))throw new Error("You can't skip a step that isn't optional.");i(a=>a+1),n(a=>{const p=new Set(a.values());return p.add(t),p})},b=()=>{i(0)};return e.jsx(w,{title:"Basic - Linear",codeString:` // HorizontalLinearStepper.tsx
